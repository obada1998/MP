        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemeName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisibleOnListing = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFieldDefinitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductFieldDefinitions_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ThemeName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    PrimaryColor = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
                    AccentColor = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: false),
                    FontFamily = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ThemeSettings_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductFieldDefinitionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCustomFieldValues_ProductFieldDefinitions_ProductFieldDefinitionId",
                        column: x => x.ProductFieldDefinitionId,
                        principalTable: "ProductFieldDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Url = table.Column<string>(type: "nvarchar(1200)", maxLength: 1200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomSnapshotJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageLayouts_PageId_Version",
                table: "PageLayouts",
                columns: new[] { "PageId", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pages_StoreId_Slug",
                table: "Pages",
                columns: new[] { "StoreId", "Slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_StoreId_CategoryId",
                table: "ProductCategories",
                columns: new[] { "StoreId", "CategoryId" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductCustomFieldValues_ProductFieldDefinitionId",
                table: "ProductCustomFieldValues",
                column: "ProductFieldDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCustomFieldValues_ProductId_ProductFieldDefinitionId",
                table: "ProductCustomFieldValues",
                columns: new[] { "ProductId", "ProductFieldDefinitionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductFieldDefinitions_StoreId_Key",
                table: "ProductFieldDefinitions",
